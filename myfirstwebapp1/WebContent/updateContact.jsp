...
<div class="jumbotron">
<form action= "UpdateContactController">

<table align="center" class="table table-striped">
<thead>

<tr><th colspan="3" align="center"><h2>Update contact</h2></th></tr></thead>

<tr><td>Id:</td><td><input type = "text" name = id id="disabledTextInput" value = "<%=id%>" readonly="readonly"></td></tr>
